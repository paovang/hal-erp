# receipt-list-excel-export Specification

## Purpose

Excel list export for receipts within a date range, including identifier, requester, status, creator, timestamp, total, and a sum-total summary row.
