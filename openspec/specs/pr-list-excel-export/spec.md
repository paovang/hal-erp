# pr-list-excel-export Specification

## Purpose

Excel list export for purchase requests within a date range, including identifier, requester, status, creator and timestamp columns.
