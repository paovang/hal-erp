# po-list-excel-export Specification

## Purpose

Excel list export for purchase orders within a date range, including identifier, requester, status, creator, timestamp, total, and a sum-total summary row.
