...
export class PurchaseRequestItemEntity extends Entity<PurchaseRequestItemId> {
  ...
  private readonly _category_id: number | null;
  ...
  private constructor(builder: PurchaseRequestItemBuilder) {
    ...
    this._category_id = builder.category_id ?? null;
  }
  ...
  public static builder(): PurchaseRequestItemBuilder {
    return new PurchaseRequestItemBuilder();
  }

  static create(
    builder: PurchaseRequestItemBuilder,
  ): PurchaseRequestItemEntity {
    return new PurchaseRequestItemEntity(builder);
  }
  ...
  async initializeUpdateSetId(purchaseRequestItemID: PurchaseRequestItemId) {
