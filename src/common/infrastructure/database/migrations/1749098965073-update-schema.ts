...
export class UpdateSchema1749098965073 implements MigrationInterface {
    name = 'UpdateSchema1749098965073'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "approval_workflows" ("id" SERIAL NOT NULL, "document_type_id" bigint, "name" character varying, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_f326145fd927565de30b360264b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_7917a8213d28515ca6b045d337" ON "approval_workflows" ("document_type_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_6b2db7a8e2c0b7286eeacdad9c" ON "approval_workflows" ("name") `);
        ...
        await queryRunner.query(`CREATE TABLE "budget_approval_rules" ("id" SERIAL NOT NULL, "department_id" bigint, "approver_id" integer, "min_amount" double precision, "max_amount" double precision, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_4892be6b3cf5860ab1da2bde6f1" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_352ff3cc7da4c58dd0d4e7f51d" ON "budget_approval_rules" ("department_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_fc0d663d0646938057ba235e7c" ON "budget_approval_rules" ("approver_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_d01591ee27a474ea3de84fd734" ON "budget_approval_rules" ("min_amount") `);
        await queryRunner.query(`CREATE INDEX "IDX_4f867671781e4c4c997721bd24" ON "budget_approval_rules" ("max_amount") `);
        ...
        await queryRunner.query(`CREATE TABLE "budget_item_details" ("id" SERIAL NOT NULL, "budget_item_id" integer, "province_id" integer, "name" character varying(255), "allocated_amount" double precision, "description" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_261c1b507757b379c1028fe4ee1" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_051d3bd5a3c0cf9ff9cb21dc13" ON "budget_item_details" ("budget_item_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_86c5f86503e19dc94395103e80" ON "budget_item_details" ("province_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_d9abf1f2c8b6365b32563e7e43" ON "budget_item_details" ("name") `);
        await queryRunner.query(`CREATE INDEX "IDX_61b8da077d44ce53fa2130316d" ON "budget_item_details" ("allocated_amount") `);
        await queryRunner.query(`CREATE INDEX "IDX_48d92e31b4cd4bdd44e8585201" ON "budget_item_details" ("description") `);
        await queryRunner.query(`CREATE TABLE "budget_items" ("id" SERIAL NOT NULL, "budget_account_id" integer, "name" character varying(255), "allocated_amount" double precision, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_9eb705f406c83a1167ef575cd7f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_f3a6c6aaff4089999873b791c6" ON "budget_items" ("budget_account_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_e93528d451155695d0b58a2603" ON "budget_items" ("name") `);
        await queryRunner.query(`CREATE INDEX "IDX_3e6793f97a496a2cea11c0df70" ON "budget_items" ("allocated_amount") `);
        await queryRunner.query(`CREATE TABLE "budget_accounts" ("id" SERIAL NOT NULL, "code" character varying(255) NOT NULL, "name" character varying(255), "fiscal_year" integer, "allocated_amount" double precision, "department_id" bigint, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "UQ_33f9bfe6adeb70b13fa4e186a4f" UNIQUE ("code"), CONSTRAINT "PK_34c44517adef513ba171445354a" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "approval_workflows" ADD CONSTRAINT "FK_7917a8213d28515ca6b045d337a" FOREIGN KEY ("document_type_id") REFERENCES "document_types"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "budget_approval_rules" ADD CONSTRAINT "FK_352ff3cc7da4c58dd0d4e7f51dc" FOREIGN KEY ("department_id") REFERENCES "departments"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "budget_approval_rules" ADD CONSTRAINT "FK_fc0d663d0646938057ba235e7cc" FOREIGN KEY ("approver_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "budget_item_details" ADD CONSTRAINT "FK_051d3bd5a3c0cf9ff9cb21dc132" FOREIGN KEY ("budget_item_id") REFERENCES "budget_items"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "budget_item_details" ADD CONSTRAINT "FK_86c5f86503e19dc94395103e80a" FOREIGN KEY ("province_id") REFERENCES "provinces"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "budget_items" ADD CONSTRAINT "FK_f3a6c6aaff4089999873b791c6f" FOREIGN KEY ("budget_account_id") REFERENCES "budget_accounts"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "budget_items" DROP CONSTRAINT "FK_f3a6c6aaff4089999873b791c6f"`);
        await queryRunner.query(`ALTER TABLE "budget_item_details" DROP CONSTRAINT "FK_86c5f86503e19dc94395103e80a"`);
        await queryRunner.query(`ALTER TABLE "budget_item_details" DROP CONSTRAINT "FK_051d3bd5a3c0cf9ff9cb21dc132"`);
        ...
        await queryRunner.query(`ALTER TABLE "budget_approval_rules" DROP CONSTRAINT "FK_fc0d663d0646938057ba235e7cc"`);
        await queryRunner.query(`ALTER TABLE "budget_approval_rules" DROP CONSTRAINT "FK_352ff3cc7da4c58dd0d4e7f51dc"`);
        ...
        await queryRunner.query(`ALTER TABLE "approval_workflows" DROP CONSTRAINT "FK_7917a8213d28515ca6b045d337a"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_3e6793f97a496a2cea11c0df70"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_e93528d451155695d0b58a2603"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_f3a6c6aaff4089999873b791c6"`);
        await queryRunner.query(`DROP TABLE "budget_items"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_48d92e31b4cd4bdd44e8585201"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_61b8da077d44ce53fa2130316d"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_d9abf1f2c8b6365b32563e7e43"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_86c5f86503e19dc94395103e80"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_051d3bd5a3c0cf9ff9cb21dc13"`);
        await queryRunner.query(`DROP TABLE "budget_item_details"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_4f867671781e4c4c997721bd24"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_d01591ee27a474ea3de84fd734"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_fc0d663d0646938057ba235e7c"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_352ff3cc7da4c58dd0d4e7f51d"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_6b2db7a8e2c0b7286eeacdad9c"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_7917a8213d28515ca6b045d337"`);
