...
export const selectPurchaseOrderItems = [
  ...
  'purchase_order_items.total_in_lak',
  'purchase_order_items.vat_in_lak',
...
export const selectPurchaseRequestItems = [
  ...
  'purchase_request_items.rate',
  'purchase_request_items.total_in_lak',
